...
public class Context extends PropertyHolder {
    ...
    /**
     * Generate files. (All files generated from here, including basic java and xml
     * files, and the modification[configured by plugins] of this files)
     *
     * @param callback
     *            the callback
    ...
    public void generateFiles(ProgressCallback callback,
        ...
        if (introspectedTables != null) {
            for (IntrospectedTable introspectedTable : introspectedTables) {
                ...
                introspectedTable.calculateGenerators(warnings, callback); //calculate the scheme for java and xml file generate
